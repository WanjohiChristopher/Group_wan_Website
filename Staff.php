    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="section_title_container text-center">
                    ...
                    <div class="team_text">
                        <p>we have a very dedicated group officials and members</p>
                        <p>TOGETHER WE CAN  MAKE IT</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row team_row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team_item">
                    ...
                    <div class="team_content text-center">
                        <div class="team_name">ERIC</div>
                        <div class="team_title">Team Lead/CHAIRPERSON</div>
                    </div>
                </div>
            </div>
            <!-- Team Item -->
            <div class="col-lg-3 col-md-6">
                <div class="team_item">
                    <div class="team_image">
                        <img src="images/team.jpg" alt="https://unsplash.com/@michaeldam">
                        <div class="team_overlay trans_400"></div>
                        <div class="team_social">
                            <ul class="d-flex flex-row align-items-center justify-content-between">
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                ...
                                <li><a href="#"><i class="fa fa-meetup" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="team_content text-center">
                        <div class="team_name">TEVIS NDUNG'U</div>
                        <div class="team_title">VICE CHAIRPERSON</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team_item">
                    ...
                    <div class="team_content text-center">
                        <div class="team_name">FRASHIA WANGARI</div>
                        <div class="team_title">VICE SECRETARY</div>
                    </div>
                </div>
            </div>
            <!-- Team Item -->
            <div class="col-lg-3 col-md-6">
                <div class="team_item">
                    ...
                    <div class="team_content text-center">
                        <div class="team_name">GRIFFIN MURIMI</div>
                        <div class="team_title">TREASURER</div>
                    </div>
                </div>
            </div>
            <!-- Team Item -->
            <div class="col-lg-3 col-md-6">
                <div class="team_item">
                    <div class="team_image">
                        <img src="images/team_5.jpg" alt="https://unsplash.com/@brookecagle">
                        <div class="team_overlay trans_400"></div>
                        <div class="team_social">
                            <ul class="d-flex flex-row align-items-center justify-content-between">
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    ...
                    <div class="team_content text-center">
                        <div class="team_name">ALICE NJOKI</div>
                        <div class="team_title">SECRETARY</div>
                    </div>
                </div>
            </div>
            <!-- Team Item -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team_item">
                    <div class="team_image">
                        <img src="images/wanjohi.jpg" alt="https://unsplash.com/@stairhopper">
                        <div class="team_overlay trans_400"></div>
                        <div class="team_social">
                            <ul class="d-flex flex-row align-items-center justify-content-between">
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    ...
                    <div class="team_content text-center">
                        <div class="team_name">WANJOHI CHRISTOPHER</div>
                        <div class="team_title">MEME</div>
                    </div>
                </div>
            </div>
